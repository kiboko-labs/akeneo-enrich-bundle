...
use Kiboko\Bundle\EnrichBundle\Form\DataTransformer\LocalizedValueCollectionTransformer;
...
class LocalizedFallbackValueCollectionType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->addViewTransformer(
            new LocalizedValueCollectionTransformer($this->registry, $options['field'])
        );
    }
